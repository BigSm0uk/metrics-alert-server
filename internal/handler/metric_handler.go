...
// // UpdateOrCreateMetricByParam реализует метод интерфейса ServerInterface
// func (h *MetricHandler) UpdateOrCreateMetricByParam(w http.ResponseWriter, r *http.Request, mType oapiMetric.Type, id oapiMetric.ID, value oapiMetric.Value) {
// 	ctx := r.Context()
...
// func (h *MetricHandler) GetValueByParam(w http.ResponseWriter, r *http.Request, mType oapiMetric.Type, id oapiMetric.ID) {
// 	ctx := r.Context()
