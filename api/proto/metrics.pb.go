...
const file_api_proto_metrics_proto_rawDesc = "" +
	...
	"\aMetrics\x12N\n" +
	"\rUpdateMetrics\x12\x1d.metrics.UpdateMetricsRequest\x1a\x1e.metrics.UpdateMetricsResponseB4Z2github.com/bigsm0uk/metrics-alert-server/pkg/protob\x06proto3"
